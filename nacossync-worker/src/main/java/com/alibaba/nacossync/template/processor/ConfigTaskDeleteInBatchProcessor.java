...
@Slf4j
@Service
public class ConfigTaskDeleteInBatchProcessor implements Processor<TaskDeleteInBatchRequest, BaseResult> {

    private final ConfigTaskAccessService configTaskAccessService;

    public ConfigTaskDeleteInBatchProcessor(ConfigTaskAccessService configTaskAccessService) {
    ...
    public void process(TaskDeleteInBatchRequest taskBatchDeleteRequest, BaseResult baseResult,
                        Object... others) {
        configTaskAccessService.deleteConfigTaskInBatch(taskBatchDeleteRequest.getTaskIds());
    }
}
