...
import com.alibaba.nacossync.template.processor.ConfigTaskAddAllProcessor;
...
public class ConfigTaskApi {
    ...
    @Resource
    private ConfigTaskUpdateProcessor configTaskUpdateProcessor;

    @Resource
    private ConfigTaskAddProcessor configTaskAddProcessor;

    @Resource
    private ConfigTaskAddAllProcessor configTaskAddAllProcessor;

    @Resource
    private ConfigTaskDeleteProcessor configTaskDeleteProcessor;

    @Resource
    private ConfigTaskDeleteInBatchProcessor configTaskDeleteInBatchProcessor;

    @Resource
    private ConfigTaskListQueryProcessor configTaskListQueryProcessor;

    @Resource
    private ConfigTaskDetailProcessor configTaskDetailProcessor;
    ...
    public BaseResult taskAddAll(@RequestBody TaskAddAllRequest addAllRequest) {
        // TODO:
        return SkyWalkerTemplate.run(configTaskAddAllProcessor, addAllRequest, new ConfigTaskAddResult());
    }
